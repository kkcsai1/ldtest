...
var AuthenticationContext = (function () {
    ...
    *  @property {string} domainHint - Domain_hint for the organization
    ...
    AuthenticationContext = function (config) {
        ...
        if (!config.domainHint) {
            throw new Error('domainHint is required');
        }
    ...
    AuthenticationContext.prototype.login = function (loginStartPage) {
        ...
        var urlNavigate = this._getNavigateUrl('id_token', null) + '&domain_hint=' + this.config.domainHint + '&nonce=' + encodeURIComponent(this._idTokenNonce);
